    ...
    return (
      ...
      <div class="container">
        ...
        <div class="row no-gutters supporters-wrap clearfix">
          ...
          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="supporter-logo">
              <img src="/images/Sponsors/9.png" class="img-fluid" alt="" />
            </div>
          </div>
          
          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="supporter-logo">
              <img src="/images/Sponsors/10.png" class="img-fluid" alt=""/>
            </div>
          </div>
        
          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="supporter-logo">
              <img src="/images/Sponsors/11.png" class="img-fluid" alt=""/>
            </div>
          </div>
          
          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="supporter-logo">
              <img src="/images/Sponsors/12.png" class="img-fluid" alt=""/>
            </div>
          </div>
        
          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="supporter-logo">
              <img src="/images/Sponsors/13.png" class="img-fluid" alt=""/>
            </div>
          </div>
